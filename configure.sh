...
install_xray(){
	...
	# Prepare
	echo "Prepare to use"
	unzip -d Xray Xray.zip && chmod +x ./Xray/xray && rm Xray.zip
}

install_dat(){
	wget -O ${PWD}/Xray/geoip.dat https://cdn.jsdelivr.net/gh/Loyalsoldier/v2ray-rules-dat@release/geoip.dat
	wget -O ${PWD}/Xray/geosite.dat https://cdn.jsdelivr.net/gh/Loyalsoldier/v2ray-rules-dat@release/geosite.dat
